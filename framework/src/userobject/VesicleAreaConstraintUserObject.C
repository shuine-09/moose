...
void
VesicleAreaConstraintUserObject::initialize()
{
  _integral = 0.0;
...
void
VesicleAreaConstraintUserObject::execute()
{
  //
...
void
VesicleAreaConstraintUserObject::executeJacobian(unsigned int jvar)
{
...
void
VesicleAreaConstraintUserObject::finalize()
{
  gatherSum(_integral);
  if (_fe_problem.currentlyComputingJacobian())
