...
[Adaptivity]
  ...
  [./Markers]
    [./box]
      bottom_left = '-0.00075 -0.00075 0'
      inside = refine
      top_right = '0.00075 0.00075 0'
      outside = do_nothing
      type = BoxMarker
    [../]
  [../]
...
[Materials]
  [ded_mat]
    ...
    thermalcapillary_coefficient = -1e-4#-4.3e-4
    #laser_center_x = '6*1e-3*10*0.001+6*1e-3*t'
    laser_center_x = '3.571e-5'
    laser_center_y = '8.1e-5'
    permeability_constant = 1e-10
    gravity = '0 -9.8 0'
