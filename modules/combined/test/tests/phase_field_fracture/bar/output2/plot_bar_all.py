...
u = data['time']
F = data['resid_x_left']
plt.plot(u,-F,label='l = 20 mm',linewidth=2.0,markerfacecolor='none',marker='>',markevery=25)


data = pandas.read_csv('400_out.csv')
u = data['time']
F = data['resid_x_left']
plt.plot(u,-F,label='l = 10 mm',linewidth=2.0,markerfacecolor='none',marker='D',markevery=25)


data = pandas.read_csv('800_out.csv')
u = data['time']
F = data['resid_x_left']
plt.plot(u,-F,label='l = 5 mm',linewidth=2.0,markerfacecolor='none',marker='^',markevery=25)


data = pandas.read_csv('1600_out.csv')
u = data['time']
F = data['resid_x_left']
plt.plot(u,-F,label='l = 2.5 mm',linewidth=2.0,markerfacecolor='none',marker='o',markevery=25)

# data = pandas.read_csv('3200_out.csv')
# u = data['time']
# F = data['resid_x_left']
# plt.plot(u,-F,label='l = 2.5 mm',linewidth=2.0,markerfacecolor='none',marker='>',markevery=50)
#
# data = pandas.read_csv('6400_out.csv')
# u = data['time']
# F = data['resid_x_left']
# plt.plot(u,-F,label='l = 2.5 mm',linewidth=2.0,markerfacecolor='none',marker='>',markevery=50)
