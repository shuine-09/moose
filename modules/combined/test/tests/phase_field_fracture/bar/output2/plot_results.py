...
data = pd.read_csv('200_out.csv')
u = data['time']
F = data['resid_x_left']
plt.plot(u,-F,'-k',label='l = 20 mm',linewidth=1.0,markerfacecolor='none',marker='>',markevery=25,c=cjam[0])


data = pd.read_csv('400_out.csv')
u = data['time']
F = data['resid_x_left']
plt.plot(u,-F,'-.k',label='l = 10 mm',linewidth=1.0,markerfacecolor='none',marker='D',markevery=25,c=cjam[1])


data = pd.read_csv('800_out.csv')
u = data['time']
F = data['resid_x_left']
plt.plot(u,-F,'--k',label='l = 5 mm',linewidth=1.0,markerfacecolor='none',marker='^',markevery=25,c=cjam[2])


data = pd.read_csv('1600_out.csv')
u = data['time']
F = data['resid_x_left']
plt.plot(u,-F,':k',label='l = 2.5 mm',linewidth=1.0,markerfacecolor='none',marker='o',markevery=25,c=cjam[3])
