...
# data = pd.read_csv('0.0_out.csv')
# u = data['time']
# F = data['resid_x_left']
# plt.plot(u,F,'-k',label='pressure = 0.0 MPa',linewidth=1.0,markerfacecolor='none',marker='>',markevery=25,c=cjam[0])
#
# data = pd.read_csv('0.2_out.csv')
# u = data['time']
# F = data['resid_x_left']
# plt.plot(u,F,'-.k',label='pressure = 0.2 MPa',linewidth=1.0,markerfacecolor='none',marker='D',markevery=25,c=cjam[1])
#
# data = pd.read_csv('0.4_out.csv')
# u = data['time']
# F = data['resid_x_left']
# plt.plot(u,F,'--k',label='pressure = 0.4 MPa',linewidth=1.0,markerfacecolor='none',marker='^',markevery=25,c=cjam[2])
#
# data = pd.read_csv('0.6_out.csv')
# u = data['time']
# F = data['resid_x_left']
# plt.plot(u,F,':k',label='pressure = 0.6 MPa',linewidth=1.0,markerfacecolor='none',marker='o',markevery=25,c=cjam[3])
#
# data = pd.read_csv('0.8_out.csv')
# u = data['time']
# F = data['resid_x_left']
# plt.plot(u,F,'-.k',label='pressure = 0.8 MPa',linewidth=1.0,markerfacecolor='none',marker='d',markevery=25,c=cjam[4])
#
# data = pd.read_csv('1.0_out.csv')
# u = data['time']
# F = data['resid_x_left']
# plt.plot(u,F,'--k',label='pressure = 1.0 MPa',linewidth=1.0,markerfacecolor='none',marker='p',markevery=25,c=cjam[5])
...
plt.xlabel("Displacement on the right boundary [mm]")
# plt.ylabel("F/A (MPa)")
plt.ylabel("Regularized Pressure (MPa)")
plt.legend()
...
ax.legend(loc='best')
plt.savefig('bar_pressure_only.pdf')
