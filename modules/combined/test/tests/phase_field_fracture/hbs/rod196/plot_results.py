...
data = pd.read_csv("bubble_pressure_r1_gas50_por10_ext0_rod196.csv",header=None)
time = data[0]
pressure = data[1]/1e6
...
ax.set_title("\n".join(wrap("Radius=1.0 $\mu$m, Initial gas pressure = 100 MPa, Porosity = 10$\%$, External pressure = 0 MPa", 50)))
ax.set_xlim(left=0)

ax.minorticks_on()
plt.savefig('bubble_pressure_r1_gas50_por10_ext0_rod196.pdf', bbox_inches='tight');
plt.close(fig)
