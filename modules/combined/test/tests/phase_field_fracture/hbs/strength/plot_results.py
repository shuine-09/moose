...
data1 = pd.read_csv("pressure_0_out.csv")
disp_x1 = data1["disp_x_right"]
stress1  = data1["ave_stress_right"]
ax.plot(disp_x1,stress1,'-',color = 'tab:blue', label="Pressure = 0 MPa")

data2 = pd.read_csv("pressure_20_out.csv")
disp_x2 = data2["disp_x_right"]
stress2  = data2["ave_stress_right"]
ax.plot(disp_x2,stress2,':',color = 'tab:orange', label="Pressure = 20 MPa")

data3 = pd.read_csv("pressure_40_out.csv")
disp_x3 = data3["disp_x_right"]
stress3  = data3["ave_stress_right"]
ax.plot(disp_x3,stress3,'-.',color = 'tab:green', label="Pressure = 40 MPa")

data4 = pd.read_csv("pressure_60_out.csv")
disp_x4 = data4["disp_x_right"]
stress4  = data4["ave_stress_right"]
ax.plot(disp_x4,stress4,'--',color = 'tab:red', label="Pressure = 60 MPa")

data5 = pd.read_csv("pressure_80_out.csv")
disp_x5 = data5["disp_x_right"]
stress5  = data5["ave_stress_right"]
ax.plot(disp_x5,stress5,':',color = 'tab:purple',label="Pressure = 80 MPa")

data6 = pd.read_csv("pressure_100_out.csv")
disp_x6 = data6["disp_x_right"]
stress6  = data6["ave_stress_right"]
ax.plot(disp_x6,stress6,'-.',color = 'tab:brown', label="Pressure = 100 MPa")
