...
#petsc_options_value = 'lu       superlu_dist'
  ...
  petsc_options_iname = '-pc_type -sub_pc_type -ksp_gmres_restart -pc_hypre_boomeramg_strong_threshold -snes_type'
  petsc_options_value = 'hypre    boomeramg    201                0.9 vinewtonrsls'
