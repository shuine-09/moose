...
ax.plot(np.divide(length_a,0.02),np.divide(p_a,sigma0),linestyle = 'None', marker='p', markersize = 7.5, label = 'Fracture strength $\sigma_c = 0.05$',c=cjam[1])
...
ax.plot(np.divide(length_a,0.02),np.divide(p_a,sigma0),linestyle = 'None', marker='D', markersize = 7.5, label = 'Fracture strength $\sigma_c = 0.10$',c=cjam[2])
...
ax.plot(np.divide(length_a,0.02),np.divide(p_a,sigma0),linestyle = 'None', marker='^', markersize = 7.5, label = 'Fracture strength $\sigma_c = 0.15$',c=cjam[3])
...
ax.plot(np.divide(length_a,0.02),np.divide(p_a,sigma0),linestyle = 'None', marker='o', markersize = 7.5, label = 'Fracture strength $\sigma_c = 0.20$',c=cjam[4])


plt.xlabel('Normalized Crack Length a/$l$')
plt.ylabel('Normalized Pressure p/$\sigma_c$')
ax.set_ylim(bottom=0)
ax.set_xlim(left=0,right=20)
plt.legend(framealpha=1.0, loc="upper right", bbox_to_anchor=(1, 1))

plt.savefig('critical_pressure.pdf')
plt.close()
