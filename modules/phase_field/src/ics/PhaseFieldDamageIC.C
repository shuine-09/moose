...
#include "PhaseFieldDamageIC.h"

registerMooseObject("PhaseFieldApp", PhaseFieldDamageIC);

InputParameters
PhaseFieldDamageIC::validParams()
{
...
PhaseFieldDamageIC::PhaseFieldDamageIC(const InputParameters & parameters)
...
Real
PhaseFieldDamageIC::dist(const Point & p)
{
  // number of cracks
...
Real
PhaseFieldDamageIC::value(const Point & p)
{
  Real damage = 0.0;
