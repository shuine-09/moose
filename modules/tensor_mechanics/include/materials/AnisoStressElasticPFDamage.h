...
/****************************************************************/
#ifndef ANISOSTRESSELASTICPFDAMAGE_H
#define ANISOSTRESSELASTICPFDAMAGE_H
 ...
 */
class AnisoStressElasticPFDamage : public ComputeStressBase
{
public:
  AnisoStressElasticPFDamage(const InputParameters & parameters);
...
#endif // AnisoStressElasticPFDamage_H
