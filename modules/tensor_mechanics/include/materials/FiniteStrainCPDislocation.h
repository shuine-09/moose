...
class FiniteStrainCPDislocation : public FiniteStrainCPSlipRateRes
{
 ...
 protected:
  /**
   * This function updates quadrature point variables after solve
  */
  ...
  /**
   * This function updates state variables after solve.
  */
  virtual void postSolveStatevar();
  /**
   * This function solves state variables.
   * Implemented as a recursive implicit update till a tolerance bound is reached.
  */
  virtual void solveStatevar();
  /**
   * This function initializes state variables prior to solve.
   */
  virtual void preSolveStatevar();
  /**
   * This function evaluates convergence of state variables.
   */
  virtual bool getIterFlag();

  virtual bool getIterFlagVar( DenseVector<Real>, DenseVector<Real>, DenseVector<Real> );
  ...
  /**
   * This function calculates plastic strain
   * Present calculation is based on reference configuration
  */
  void calc_plastic_strain();
  ...
  DenseVector<Real> _slip_incr_glide;
  DenseVector<Real> _dslipdtau_glide;
  DenseVector<Real> _rho_m,_rho_m_old,_rho_m_prev;
  DenseVector<Real> _rho_i,_rho_i_old,_rho_i_prev;

  DenseVector<Real> _interaction_matrix;
  DenseVector<Real> _s_therm, _s_atherm;
