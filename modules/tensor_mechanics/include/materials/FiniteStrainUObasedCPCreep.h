...
#ifndef FINITESTRAINUOBASEDCPCREEP_H
#define FINITESTRAINUOBASEDCPCREEP_H
...
class FiniteStrainUObasedCPCreep;

template <>
InputParameters validParams<FiniteStrainUObasedCPCreep>();

/**
 * FiniteStrainUObasedCPCreep uses the multiplicative decomposition of deformation gradient
 ...
 */
class FiniteStrainUObasedCPCreep : public ComputeStressBase
{
public:
  FiniteStrainUObasedCPCreep(const InputParameters & parameters);
...
protected:
  ...
  MaterialProperty<Real> & _w_bd;
  const MaterialProperty<Real> & _w_bd_old;

  MaterialProperty<Real> & _w_sd;
  const MaterialProperty<Real> & _w_sd_old;

  MaterialProperty<Real> & _w_dis;
  const MaterialProperty<Real> & _w_dis_old;
