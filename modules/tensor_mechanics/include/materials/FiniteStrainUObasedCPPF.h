...
#ifndef FINITESTRAINUOBASEDCPPF_H
#define FINITESTRAINUOBASEDCPPF_H
...
class FiniteStrainUObasedCPPF;

template <>
InputParameters validParams<FiniteStrainUObasedCPPF>();

/**
 * FiniteStrainUObasedCPPF uses the multiplicative decomposition of deformation gradient
 ...
 */
class FiniteStrainUObasedCPPF : public ComputeStressBase
{
public:
  FiniteStrainUObasedCPPF(const InputParameters & parameters);
...
protected:
  ...
  virtual void calculateCrackDrivingStateFunction();
  ...
  MaterialProperty<RankTwoTensor> & _lag_el;
  MaterialProperty<RankTwoTensor> & _lag_pl;
