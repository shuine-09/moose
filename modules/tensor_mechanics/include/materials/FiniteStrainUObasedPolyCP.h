...
/****************************************************************/
#ifndef FINITESTRAINUOBASEDPOLYCP_H
#define FINITESTRAINUOBASEDPOLYCP_H
...
class FiniteStrainUObasedPolyCP;
class GrainTracker;
...
/**
 * FiniteStrainUObasedPolyCP uses the multiplicative decomposition of deformation gradient
 ...
 */
class FiniteStrainUObasedPolyCP : public ComputeStressBase
{
public:
  FiniteStrainUObasedPolyCP(const InputParameters & parameters);
...
protected:
  ...
  */
  ...
  /**
    * calcuate equivalent stress
  */
  virtual void finalSolveSressQp();
