...
#include "ComputeLinearElasticPFFractureStressWithLinearFractureEnergy.h"

registerMooseObject("TensorMechanicsApp",
                    ComputeLinearElasticPFFractureStressWithLinearFractureEnergy);

template <>
InputParameters
validParams<ComputeLinearElasticPFFractureStressWithLinearFractureEnergy>()
{
...
void
ComputeLinearElasticPFFractureStressWithLinearFractureEnergy::initQpStatefulProperties()
{
  _hist[_qp] = 3 * _gc[_qp] / 16 / _l[_qp];
}

void
ComputeLinearElasticPFFractureStressWithLinearFractureEnergy::computeQpStress()
{
  Real c = _c[_qp];
