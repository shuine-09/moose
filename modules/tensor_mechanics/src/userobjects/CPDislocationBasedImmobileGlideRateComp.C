...
registerMooseObject("TensorMechanicsApp", CPDislocationBasedImmobileGlideRateComp);

template <>
InputParameters
validParams<CPDislocationBasedImmobileGlideRateComp>()
{
  ...
  params.addClassDescription(
      ...
      "component for glide mechanism. Override the virtual functions in your class");
  return params;
}

CPDislocationBasedImmobileGlideRateComp::CPDislocationBasedImmobileGlideRateComp(
...
bool
CPDislocationBasedImmobileGlideRateComp::calcStateVariableEvolutionRateComponent(
