...
registerMooseObject("TensorMechanicsApp", CPDislocationBasedThermalSlipResistance);

template <>
InputParameters
validParams<CPDislocationBasedThermalSlipResistance>()
{
...
CPDislocationBasedThermalSlipResistance::CPDislocationBasedThermalSlipResistance(
    const InputParameters & parameters)
  : CrystalPlasticitySlipResistance(parameters), _thermal_resist(getParam<Real>("thermal_resist"))
{
}

bool
CPDislocationBasedThermalSlipResistance::calcSlipResistance(unsigned int qp,
