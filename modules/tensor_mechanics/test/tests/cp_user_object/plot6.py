...
case1 = pandas.read_csv('no_fracture.csv')
strain1 = case1['time']
stress_yy1 = case1['stress_yy']

plt.plot(strain1,stress_yy1,label='No fracture')

case2 = pandas.read_csv('test1.csv')
strain2 = case1['time']
stress_yy2 = case1['stress_yy']

plt.plot(strain1,stress_yy2,label='gc = 30')
