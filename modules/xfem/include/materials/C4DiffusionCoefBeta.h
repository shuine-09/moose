...
public:
  ...
  C4DiffusionCoefBetaTempl(const InputParameters & parameters);
...
typedef C4DiffusionCoefBetaTempl<false> C4DiffusionCoefBeta;
typedef C4DiffusionCoefBetaTempl<true> ADC4DiffusionCoefBeta;
