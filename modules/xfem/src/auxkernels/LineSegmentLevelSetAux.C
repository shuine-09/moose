  ...
  : AuxKernel(parameters)
{
  ...
  if (dynamic_cast<const MovingLineSegmentCutSetUserObject *>(uo) == nullptr)
    mooseError("UserObject casting to MovingLineSegmentCutSetUserObject in LineSegmentLevelSetAux");

  _linesegment_uo = dynamic_cast<const MovingLineSegmentCutSetUserObject *>(uo);
}
