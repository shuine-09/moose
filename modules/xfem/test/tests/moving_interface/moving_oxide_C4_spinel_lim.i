...
[UserObjects]
  [./fixed_cut_oxide_metal]
    ...
    #cut_data = '10 0 10 6 0 0'
    cut_data = '105 0 105 0.4 0 0'
  [../]
  [./velocity_oxide]
  ...
  [./moving_cut_oxide]
    ...
    #cut_data = '10.5 0 10.5 6 0 0'
    cut_data = '105.3 0 105.3 0.4 0 0'
    heal_always = true
...
[ICs]
  [./ic_Mn]
    type = FunctionIC
    variable = C_Mn
    function = 'if(x<95, 7.1445,if(x<105,7.1445-7.1445/10*(x-95),if(x<105.3,13.3179,13.3152)))'
  [../]
[]
