...
# The length unit is the microometer. The time unit is the hour
...
[UserObjects]
  ...
  [./moving_cut_oxide]
    ...
    cut_data =  '101 0 101 20 0 0' #'100.3 0 100.3 20 0 0'
    heal_always = true
...
[ICs]
  [./ic_Mn]
    type = FunctionIC
    variable = C_Mn
    function = 'if(x<100,5,10)' #'if(x<97,7.1445,if(x<100,7.1445-7.1445/3*(x-97),if(x<100.3,13.3179,13.3152)))'
  [../]
[]
...
[Constraints]
  [./oxide_metal_constraint]
    ...
    variable = C_Mn
    value_at_positive_level_set_interface = 5 #0
    value_at_negative_level_set_interface = 10 #13.3179
    alpha = 1e5
  [../]
